    ...
    <section class="breadcumb-area bg-img" style="background-image: url(<?=base_url();?>libraries/img/bg-img/s12.jpg); box-shadow: 0px 0px 10px 1px rgba(0,0,0,0.9);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content wow fadeInUp">
                        <h3 class="breadcumb-title">Productos Hogar</h3>
                    </div>
                    <br>
                     <div class="breadcumb-content wow fadeInUp">
            ...
            <div class="row">
                <div  class="col-12">
                	<div style="background-color: #7d7d7d; border-radius: 20px;" class="section-heading wow fadeInUp">
                            <h1 style="color: #000;">Lámparas para el hogar</h1>
...
<?php
            ...
            <?php
                ...
                foreach ($productos as $prod):
                    if ($prod->id_Categoria_Producto == 2){            
            ?>     
