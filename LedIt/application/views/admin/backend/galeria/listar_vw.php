...
<body>
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
              <div class=>
                <div style="box-shadow: 0px 0px 10px -5px rgba(10,17,35,0.9); border-bottom-right-radius: 20px; border-bottom-left-radius: 20px"s class="x_panel">
                  <div class="x_title">
                     <h3>Galería <small>Listado de registros</small></h3>
                    <div class="clearfix"></div>       
                  </div>
                    <?php echo $output; ?>
                </div>
