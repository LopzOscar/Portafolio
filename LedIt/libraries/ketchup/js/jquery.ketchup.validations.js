...
.validation('minlength', '¡ Debe de contener mínimo {arg1} caracteres ! ', function(form, el, value, min) {
  return (value.length >= +min);
})

.validation('maxlength', '¡ Debe de contener máximo {arg1} caracteres !', function(form, el, value, max) {
...
.validation('number', '¡ Ingresa solo números !', function(form, el, value) {
...
.validation('email', '¡ Ingresa un email válido !', function(form, el, value) {
